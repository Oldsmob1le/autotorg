    ...
    return (
        <div className="catalog container">
            <div className="header-container">
                ...
                <Link to="/" className="home1-button">Вернуться на главную →</Link>
            </div>
            
            <div className="category-filter">
                <button onClick={() => handleCategoryChange('')}>Все категории</button>
                <button onClick={() => handleCategoryChange('Полотенца')}>Полотенца</button>
                <button onClick={() => handleCategoryChange('Пылесосы')}>Пылесосы</button>
                <button onClick={() => handleCategoryChange('Диффузоры')}>Диффузоры</button>
                <button onClick={() => handleCategoryChange('Ароматизатор')}>Ароматизаторы</button>
            </div>
